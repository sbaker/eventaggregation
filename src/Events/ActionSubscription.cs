namespace Events
{
    ...
    public sealed class ActionTSubscription<TData>(EventId eventId, IEventAggregator aggregator, Action<EventContext<TData>> callback) : Subscription<Action<EventContext<TData>>>(eventId, aggregator, callback)
    {
